...
> 通过选择一些页面，描述设计中**通用**的操作方法与一些**特殊**的需要注明的交互设计。
...
![首页-主菜单](https://s3.ax1x.com/2020/12/14/rm658K.jpg)

### 拨号

遥控器按方向键的上下键切换选择拨号菜单（拨号、最近呼叫、通讯录、分组），右侧内容根据所选菜单切换，按遥控器方向键中间的确认键 <i class="iconfont">&#xe884;</i> 或方向右键 <i class="iconfont">&#xe886;</i> 进入该菜单内容编辑或选项的第一个项目，如“拨号”则进入第一项“输入 IP”。按左键 <i class="iconfont">&#xe88a;</i> 或返回键 <i class="iconfont">&#xe882;</i> 返回上一级菜单。

1. 通过遥控器的数字键，输入 IP ，当前获得焦点的输入框呈高亮展示，输入完成按确认键后，呼叫图标变为可用状态，方向右键 <i class="iconfont">&#xe886;</i> 选中后按下确认键 <i class="iconfont">&#xe884;</i> 或遥控器上的拨号键 <i class="iconfont">&#xe87e;</i> 开始呼叫；

![呼叫-输入IP](https://s3.ax1x.com/2020/12/13/rmG31P.jpg)

![拨号-选择拨打](https://s3.ax1x.com/2020/12/13/rmG1pt.jpg)

1. 按方向下键 <i class="iconfont">&#xe88b;</i> 切换到呼叫设置（分辨率、速率、协议），方向左右键进行切换，按确认键 <i class="iconfont">&#xe884;</i> 调出可选项目，如下图选择“分辨率”中的可选项，无干扰模式。
...
4. 最近呼叫，选中一条记录后按确认键 <i class="iconfont">&#xe884;</i> 进入无干扰模式操作，可执行再次呼叫、查看详情、添加至通讯录、删除记录操作。
...
在呼叫页面按方向下键 <i class="iconfont">&#xe88b;</i> 切换到通讯录列表，按确认键 <i class="iconfont">&#xe884;</i> 或方向右键 <i class="iconfont">&#xe886;</i> 进入通讯录列表，默认选中第一条。

1. 再按方向右键 <i class="iconfont">&#xe886;</i> 可选择新建联系人或通过字母检索；

![通讯录-列表-检索](https://s3.ax1x.com/2020/12/13/rmJsPA.jpg)

2. 在列表选中联系人按确认键 <i class="iconfont">&#xe884;</i> 进行操作（呼叫、编辑、删除以及设置常用联系人）；
...
- 关闭“自动设置“日期与时间：则出现“时间”与“日期”输入项，日期可以通过左右方向键选择数字或者按确认键 <i class="iconfont">&#xe884;</i> 直接输入数字：

![设置-日期与时间-手动2](https://s3.ax1x.com/2020/12/13/rmDNY8.jpg)
